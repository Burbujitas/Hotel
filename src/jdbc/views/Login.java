...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/jdbc/imagenes/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/jdbc/imagenes/lOGO-50PX.png")));
	...
	private void Login() {
			...
			usuario.setContraseña(contrase);

	        if(usuarioController.iniciarSesion(usuario)){
