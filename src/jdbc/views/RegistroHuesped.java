...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/jdbc/imagenes/icon-reservas.png")));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(txtApellido.getText()!=null && txtFechaN.getDate() != null && txtNreserva.getText() != null && txtNombre.getText() != null && txtNacionalidad.getSelectedItem()!=null)
				{
					guardarHuesped();
				}else{
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/jdbc/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/jdbc/imagenes/Ha-100px.png")));
	...
	public void guardarHuesped()
	{
		...
		Huespedes huesped = new Huespedes(txtNombre.getText(),txtApellido.getText(),java.sql.Date.valueOf(fecha),txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(),Integer.parseInt(txtNreserva.getText()));
