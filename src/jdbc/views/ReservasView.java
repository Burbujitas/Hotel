...
public class ReservasView extends JFrame {
	...
	private static JTextField txtHabitacionId;
	int xMouse, yMouse;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReservasView frame = new ReservasView(0);
	 ...
	 * Create the frame.
	 */
	public ReservasView(int idHabitacion) {
		super("Reserva");
		this.reservaController = new ReservaController();
		this.idHabitacion = idHabitacion;
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/jdbc/imagenes/aH-40px.png")));
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/jdbc/imagenes/icon-reservas.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/jdbc/imagenes/icon-reservas.png")));
	...
	private void guardarReserva(){
		...
		Reserva nuevaReserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS),Double.parseDouble(txtValor.getText()),txtFormaPago.getSelectedItem().toString(),idHabitacion);
